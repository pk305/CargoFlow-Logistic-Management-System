...
import { CCol, CFormFeedback, CFormInput, CRow, CFormSelect, CButton } from '@coreui/react'
  ...
  return (
    <div>
      <form
        ...
        id="new_loading"
        onSubmit={(e) => handleDeliveryBooking(e, '4')}
      >
        <h4 className="cstPageTitle">Delivery Point</h4>
        <h6 className="subTitleHeading">Step: 4/5</h6>
        ...
        <div className="row">
          <CCol sm={12} md={12} lg={12} xl={12}>
            <CRow>
              ...
              <CCol sm={6} md={3} lg={3} xl={3}>
                <div
                  className="form-group company optional loading_delivery_id"
                  data-select2-id="2471"
                >
              ...
              <CCol sm={6} md={2} lg={2} xl={2}>
                <div className="form-group select">
                  <label
                    ...
                    htmlFor="loading_unload_place_type"
                  >
                    Delivery Place
                  </label>
                  <CFormSelect
                    ...
                    invalid={
                      bookingErrors && !isEmpty(bookingErrors.unLoadPlaceType) ? true : false
                    }
                    onChange={(e) => handleChangeDeliveryPlace(e)}
                    onFocus={() =>
                      dispatch(
                        clearBookingError({ type: 'unLoadPlaceType', errorType: 'errBooking' }),
                      )
                    }
                  >
                  ...
                  <div>
                    <div className="input-group">
                      <CFormInput
                        ...
                        invalid={
                          bookingErrors && !isEmpty(bookingErrors.unloadPlace) ? true : false
                        }
                        onChange={(e) => handleChangeForm(e)}
                        onFocus={() =>
                          dispatch(
                            clearBookingError({ type: 'unloadPlace', errorType: 'errBooking' }),
                          )
                        }
                      />
                      <CFormFeedback invalid className="fieldError-cst">
            ...
            <CRow>
              <CCol sm={6} md={3} lg={3} xl={3}>
                <div className="form-group">
                  <label
                    ...
                    htmlFor="loading_unload_custom_id"
                  >
                  ...
                  <div>
                    <div className="input-group">
                      <Select
                        className={classNames('form-control form-control-cst pageCstSelect ', {
                          'is-invalid':
                            bookingErrors && !isEmpty(bookingErrors.unLoadCustomOfficerId),
                        })}
              ...
              <CCol sm={6} md={3} lg={3} xl={3}>
                <div className="form-group place optional loading_unload_center_id">
                  <label
                    className="control-label place optional"
                    htmlFor="loading_unload_center_id"
                  >
                    Unload Center
                  </label>
                  <div>
...
DeliveryPoints.propTypes = {
  ...
  handleDeliveryBooking: PropTypes.func.isRequired,
}
