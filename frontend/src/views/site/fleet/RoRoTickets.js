          ...
          <div className="pageSearchContainer">
            <div className="filter-actions">
              ...
              <div className="filterSelected-text">
                {selectedFlatRows.length === 1 ? 'Company' : 'RoRoTickets'} Selected
              </div>
...
const RoRoTickets = () => {
  ...
  const [breadcrumbList] = useState([
    ...
    { name: 'RoRo Tickets', pathname: '/transdocs?view_scope=roro', active: true },
  ])
                ...
                <div className="customHeaderContainer">
                  <div className="customHeaderContainer-footer">
                    <div className="card-title">
                      <h3 className="cstCardbodyHeaderTitle">RoRo Tickets</h3>
                    </div>
                  </div>
                </div>
                <div className="customHeaderToolbar">
                  <CButtonGroup>
                    <CButton color="primary" active onClick={(e) => toLink(e, '/workorders/new')}>
                      RoRo Tickets
                    </CButton>
                  </CButtonGroup>
                </div>
