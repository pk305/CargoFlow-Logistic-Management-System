          ...
          <div className="pageSearchContainer">
            <div className="filter-actions">
              ...
              <div className="filterSelected-text">
                {selectedFlatRows.length === 1 ? 'Company' : 'FacilityManagement'} Selected
              </div>
...
const FacilityManagement = () => {
  ...
  const [breadcrumbList] = useState([
    ...
    { name: 'Facility Management', pathname: '/facility_managements', active: true },
                ...
                <div className="customHeaderContainer">
                  <div className="customHeaderContainer-footer">
                    <div className="card-title">
                      <h3 className="cstCardbodyHeaderTitle">Facility Management</h3>
                    </div>
                  </div>
                </div>
