...
const PaymentReceiptTempdoc = ({ reqData, itemDocType, tempdocDataId, itemDocId, docName }) => {
  ...
  const handleSetTempDoc = useCallback(() => {
    if (reqData) {
      ...
      setTempdocData((state) => ({
        ...
        account: req.account,
        account2: req.account,
        accountHeader: req.accountHeader,
        accountHeader2: req.accountHeader,
        alone: req.alone,
        alone2: req.alone,
        amount: req.amount,
        amount2: req.amount,
        ...
        confirm: req.confirm,
        confirm2: req.confirm,
        confirmHeader: req.confirmHeader,
        confirmHeader2: req.confirmHeader,
        date: req.date,
        date2: req.date2,
        ...
        docNo: req.docNo,
        docNo2: req.docNo,
        docNoHeader: req.docNoHeader,
        docNoHeader2: req.docNoHeader,
        exchange: req.exchange,
        exchange2: req.exchange,
        exchangeHeader: req.exchangeHeader,
        exchangeHeader2: req.exchangeHeader,
        explanation: req.explanation,
        explanation2: req.explanation,
        explanationHeader: req.explanationHeader,
        explanationHeader2: req.explanationHeader,
        findocId: req.findocId,
        imgLogoUrl: req.imgLogoUrl,
        mainTitle: req.mainTitle,
        mainTitle2: req.mainTitle,
        message: req.message,
        message2: req.message,
        nameSignature: req.nameSignature,
        operator: req.operator,
        operator2: req.operator,
        operatorHeader: req.operatorHeader,
        operatorHeader2: req.operatorHeader,
        qrcodeUrl: req.qrcodeUrl,
        subject: req.subject,
        subject2: req.subject,
        titleHeader: req.titleHeader,
        titleHeader2: req.titleHeader,
        total: req.total,
        total2: req.total,
  ...
  const saveTempDoc = async (e) => {
    ...
    if (resData) {
      ...
      history.push('/financor/bank_trans')
    }
  }
    ...
    <div className="containerPreview">
      <div className="hidden-print preview_button">
        <div className="form-actions">
          <form id="updatetempdoc_">
            <CButton color="primary" className="mr-2" onClick={(e) => printTempdoc(e)}>
              Print
            </CButton>
            <CButton color="primary" className="mr-2" onClick={(e) => pdfDownload(e)}>
              PDF
            </CButton>
            {/* <CButton
              color="primary"
            ...
            <CButton color="primary" className="mr-2" onClick={(e) => sendMailTempdoc(e)}>
              Send Mail
            </CButton>
            <CButton
              color="primary"
...
PaymentReceiptTempdoc.propTypes = {
  itemDocType: PropTypes.string,
  itemDocId: PropTypes.number,
  docName: PropTypes.string,
  reqData: PropTypes.object,
  tempdocDataId: PropTypes.string,
}

export default PaymentReceiptTempdoc
