...
import { destroyUser, fetchUsers } from 'src/redux/slices/userSlice'
    ...
    var n = new Noty({
      ...
      buttons: [
        Noty.button(
          ...
          async function () {
            const selectedIds = items.map((x) => ({ Id: x.original.uuid }))
          ...
          <div className="pageSearchContainer">
            <div className="filter-actions">
              ...
              <div className="filterSelected-text">
                {selectedFlatRows.length === 1 ? 'User' : 'Users'} Selected
              </div>
              <div className="filterButtons">
                <CButton
                  color="danger"
                  variant="ghost"
                  onClick={(e) => handleRemoveItem(e, selectedFlatRows)}
                >
      ...
      <div className="pageBoxSizing-container cst-tableResponsive">
        <div className="table-responsive table-truncate pageTableWrapper">
          <div>
            ...
            {/* table info */}
            {!fetchingUsers && !firstPageRows.length > 0 && (
...
const Users = () => {
  ...
  const [breadcrumbList] = useState([
    { name: 'Users', pathname: '/manage/users', active: true },
    // { name: 'Locations', pathname: '/locations' },
    // { name: 'Operations', pathname: '/leads' },
  ])
  ...
  return (
    <div>
                ...
                <div className="customHeaderContainer">
                  <div className="customHeaderContainer-footer">
                    <div className="card-title">
                      <h3 className="cstCardbodyHeaderTitle">Users</h3>
                    </div>
                  </div>
                </div>
      ...
      >
        <div>
          <CreateUser handleCancelSlide={handleCancelSlide} />
        </div>
