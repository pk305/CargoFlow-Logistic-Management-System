...
const Companies = () => {
  ...
  const [breadcrumbList] = useState([
    ...
    { name: 'Company Notes', pathname: '/notices', active: true },
                ...
                <div className="customHeaderContainer">
                  <div className="customHeaderContainer-footer">
                    <div className="card-title">
                      <h3 className="cstCardbodyHeaderTitle">Company Notes</h3>
                    </div>
                  </div>
                </div>
                <div className="customHeaderToolbar">
                  <CButtonGroup>
                    <CButton color="primary" active onClick={(e) => createCompanyNotes(e)}>
                      <i className="fa fa-plus mr-2" /> Create Company Notes
                    </CButton>
                  </CButtonGroup>
                </div>
              </div>
      ...
      >
        <div>
          <div className="card cardCustom gutter-b">
            <div className="card-body p-6">dd</div>
          </div>
        </div>
