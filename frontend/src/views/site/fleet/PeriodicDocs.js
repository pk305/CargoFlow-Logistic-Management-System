...
import NewPeriodicDoc from './panels/NewPeriodicDoc'
          ...
          <div className="pageSearchContainer">
            <div className="filter-actions">
              ...
              <div className="filterSelected-text">
                {selectedFlatRows.length === 1 ? 'Company' : 'PeriodicDocs'} Selected
              </div>
...
const PeriodicDocs = () => {
  const [breadcrumbList] = useState([
    ...
    { name: 'Periodic Documents', pathname: '/periodocs', active: true },
  ...
  useEffect(() => {
    document.title = 'Periodic Documents'
    //
    // fetchCompanyData()
  }, [])
    ...
    <div className="fleetContainer">
                ...
                <div className="customHeaderContainer">
                  <div className="customHeaderContainer-footer">
                    <div className="card-title">
                      <h3 className="cstCardbodyHeaderTitle">Periodic Documents</h3>
                    </div>
                  </div>
                </div>
                <div className="customHeaderToolbar">
                  <CButtonGroup>
                    <CButton color="primary" active onClick={(e) => handleNewPeriodDoc(e)}>
                      <i className="fa fa-plus mr-2" /> Create Periodic Document
                    </CButton>
                  </CButtonGroup>
                </div>
              </div>
      ...
      <SlidingPane
        ...
        title={
          <div className="space">
            <div>
              <span>New Periodic Document</span>
            </div>
            <div>
              <button
                className="btn btn-close"
                aria-label="Close"
                onClick={(e) => setPeriodPanel(false)}
              ></button>
            </div>
          </div>
        }
