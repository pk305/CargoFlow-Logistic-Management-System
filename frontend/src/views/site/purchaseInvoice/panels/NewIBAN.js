...
const NewIBAN = ({ showCompany, closeIbanPanel, changeIbans }) => {
  ...
  return (
    <div className="pageContainer m-0" id="ibanPane">
              ...
              <div className="d-block">
                <div className="row">
                  <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    <div className="form-group select iban_bank_id">
                      <label className="control-label select" htmlFor="iban_bank_id">
                        Bank
                      </label>
                      <CFormSelect
                  ...
                  <div className="col-12 col-sm-12 col-md-4 col-lg-2 col-xl-2">
                    <div className="form-group select iban_curr">
                      <label className="control-label select" htmlFor="iban_curr">
                        Currency
                      </label>
                      <div className="input-group">
                        <Select
                          className={classNames('form-control form-control-cst pageCstSelect ', {
                            'is-invalid': ibanErrors && !isEmpty(ibanErrors.curr),
                          })}
                          ...
                          onMenuOpen={() => handleSelectFocus('curr')}
                        />
                        <CFormFeedback invalid className="fieldError-cst">
                          {ibanErrors.curr}
                        </CFormFeedback>
                  ...
                  <div className="col-12 col-sm-12 col-md-4 col-lg-2 col-xl-2">
                    <div className="form-group boolean iban_is_default">
                      <label className="boolean" htmlFor="iban_is_default">
                        Default
                      </label>
      ...
      <CCard className="cardCustom gutter-b">
        <div className="card-header">
          <div className="card-title">
            <h6 className="card-label">Registerd Accounts</h6>
          </div>
        </div>
        <div className="card-body">
