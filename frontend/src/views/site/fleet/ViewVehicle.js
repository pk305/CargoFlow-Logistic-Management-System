...
import { findVehicle } from 'src/redux/slices/vehicleSlice'
...
const ViewVehicle = () => {
  ...
  const { showVehicle } = useSelector((state) => state.vehicle)
                    ...
                    <div className="customMiniBar-body">
                      <div className="minItem">
                        ...
                        <span className="minItem-text">
                          {showVehicle && showVehicle.createdBy && showVehicle.createdBy.name}
                        </span>
                      </div>
                      <div className="minItem">
            ...
            <CCol sm={12} md={12} lg={7} xl={8}>
              <div className="row">
                <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-slide-12">
                  <div className="row" id="vehicle_18676_details">
                        ...
                        <div className="card-header py-1">
                          ...
                          <div className="card-toolbar">
                            <a
                              ...
                              data-remote="true"
                              href="/vehicles/18676-dm1960cl/edit?form_scope=modal"
                            >
                        ...
                        <div className="card-body">
                          <div className="table-responsive">
                            <table className="table">
                              <tbody>
                                <tr>
                                  <td className="font-weight-bolder">Plate / Code</td>
                                  <td>DM1960CLDD</td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Vehicle className</td>
                                  <td>Wagon</td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Vehicle type</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Brand</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Model</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Year</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Odometer</td>
                                  <td>0</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="font-weight-bolder">Driver</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Owned/Rented</td>
                                  <td>Owned</td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Owner Company</td>
                                  <td>Halmac Transporters</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="font-weight-bolder">Approver</td>
                                  <td>James</td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Approved Date</td>
                                  <td>29/04/2022</td>
                                </tr>
                              </tbody>
                            </table>
                        ...
                        <div className="card-header py-1">
                          ...
                          <div className="card-toolbar">
                            <a
                              className="btn btn-sm btn-icon btn-secondary ml-2"
                              data-remote="true"
                              href="/vehicles/18676-dm1960cl/edit?form_scope=detail"
                            >
                              <i className="far fa-pen"></i>
                            </a>{' '}
                          </div>
                        ...
                        <div className="card-body">
                          <div className="table-responsive">
                            <table className="table">
                              <tbody>
                                <tr>
                                  <td className="font-weight-bolder">Weight</td>
                                  <td>0.0</td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Height/Width/Depth</td>
                                  {/* eslint-disable-next-line react/jsx-no-comment-textnodes */}
                                  <td>//</td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Volume</td>
                                  <td>0.0</td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Tailboard</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Roof</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Tonnage / Automatic Tonaj</td>
                                  <td>0.0 / </td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Tire Size</td>
                                  <td>/0/0</td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Axle Count</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Components</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Current Number Of Belts</td>
                                  <td>0</td>
                                </tr>
                                <tr>
                        ...
                        <div className="card-header py-1">
                          ...
                          <div className="card-toolbar">
                            <a
                              className="btn btn-sm btn-icon btn-secondary ml-2"
                              data-remote="true"
                              href="/vehicles/18676-dm1960cl/edit?form_scope=licence"
                            >
                              <i className="far fa-pen"></i>
                            </a>{' '}
                          </div>
                        ...
                        <div className="card-body">
                          <div className="table-responsive">
                            <table className="table">
                              <tbody>
                                <tr>
                                  <td className="font-weight-bolder">Vehicle Color</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">License Number</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">License Place</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Chassis Number</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Engine Number</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Registration Number</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Registration Date</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Net Weight</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Hourse Power</td>
                                  <td></td>
                                </tr>
                              </tbody>
                            </table>
                        ...
                        <div className="card-header py-1">
                          ...
                          <div className="card-toolbar">
                            <a
                              className="btn btn-sm btn-icon btn-secondary ml-2"
                              data-remote="true"
                              href="/vehicles/18676-dm1960cl/edit?form_scope=fuel"
                            >
                              <i className="far fa-pen"></i>
                            </a>{' '}
                          </div>
                        ...
                        <div className="card-body">
                          <div className="table-responsive">
                            <table className="table">
                              <tbody>
                                <tr>
                                  <td className="font-weight-bolder">Fuel type</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Fuel Unit</td>
                                  <td>Liter</td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Fuel Capacity</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">
                                    Default Fuel Consumption Rate
                                  </td>
                                  <td>0.0</td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Fuel Limit</td>
                                  <td></td>
                                </tr>
                                <tr>
                                  <td className="font-weight-bolder">Last two fuel averages</td>
                                  <td>0</td>
                                </tr>
                              </tbody>
                            </table>
                ...
                <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-slide-12 hide">
                  <div className="card card-custom gutter-b">
                    <div className="card-header py-1">
                      <div className="card-title">
                        <h6 className="card-label font-weight-bolder text-dark">Service Logs</h6>
                      </div>
                      <div className="card-toolbar">
                        <a
                          className="btn btn-sm btn-dark ml-2"
                          title="Add New Service Maintenance Record"
                          data-remote="true"
                          href="/vehicles/18676/servicelogs/new"
                        >
                          Add New Service Log
                        </a>
                      </div>
                    </div>
                    <div className="card-body" id="vehicle_18676_servicelogs_list">
                      <div className="table-responsive table-truncate mt-8 min-h-300px">
                        <table id="servicelogs_list_table" className="table table-vertical-center">
                          <thead>
                            <tr className="text-dark text-uppercase">
                              <th></th>
                              <th className="sticky left-0 top-0 z-100 fixed-column">Reference</th>
                              <th>Service Date</th>
                              <th>Vehicle</th>
                              <th>Odemeter</th>
                              <th>Invoice No</th>
                              ...
                              <th>User</th>
                              <th className="sticky right-0 top-0 z-100 fixed-column">Status</th>
                              <th className="text-center">Service Status</th>
                            </tr>
                          </thead>
                          <tbody id="servicelogs_list_table_body"></tbody>
                        </table>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="card-header py-1">
                      ...
                      <div className="card-toolbar">
                        <a
                          ...
                          title="Add New Service Maintenance Record"
                          data-remote="true"
                          href="/periodocs/new?scope=vehicle&amp;vehicle_id=18676"
                        >
                          Add New Periodic Document
                        </a>
                      </div>
                    </div>
                    <div className="card-body" id="vehicle_18676_periodocs_list">
                      <div className="table-responsive table-truncate mt-8 min-h-300px">
                        <table id="periodocs_list_table" className="table table-vertical-center">
                          <thead>
                            <tr className="text-dark text-uppercase">
                              <th></th>
                              <th>Document Type</th>
                          ...
                          <tbody id="periodocs_list_table_body"></tbody>
                        </table>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-slide-12 hide">
                  <div className="card card-custom gutter-b">
                    <div className="card-header py-3">
                      <div className="card-title">
                        <h6 className="card-label font-weight-bolder text-dark">Transports</h6>
                      </div>
                    </div>
                    <div className="card-body">
                      <div className="panel">
                        <div className="table-responsive table-truncate">
                          <table id="positions_list_table" className="table">
                            <thead>
                              <tr>
                                <th></th>
                                <th>Reference</th>
                                ...
                                <th>Driver Phone</th>
                                <th>Branch</th>
                                <th>Carrier Freight Price</th>
                                <th>Order Date</th>
                                <th>Notes</th>
                                <th></th>
                              </tr>
                            </thead>
                            <tbody id="positions_list_table_body"></tbody>
                          </table>
                        </div>
                      </div>
                      <input type="hidden" id="selected_expense_form_id" value="" />
                    </div>
                  </div>
                </div>
                <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-slide-12 hide">
                  <div className="card card-custom gutter-b">
                    <div className="card-header py-3">
                      <div className="card-title">
                        <h6 className="card-label font-weight-bolder text-dark">Gate Actions</h6>
                      </div>
                    </div>
