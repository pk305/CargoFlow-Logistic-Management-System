...
const Tenders = () => {
  ...
  const [breadcrumbList] = useState([
    ...
    { name: 'Tenders', pathname: '/tenders', active: true },
  ])
            ...
            <div className="table-action-dropdown">
              <CDropdown>
                ...
                <CDropdownMenu>
                  ...
                  <CDropdownItem>
                    <i className="fa fa-times" /> Social Media
                  </CDropdownItem>
                  <CDropdownItem>
                ...
                <div className="customHeaderContainer">
                  <div className="customHeaderContainer-footer">
                    <div className="card-title">
                      <h3 className="cstCardbodyHeaderTitle">Tenders</h3>
                    </div>
                  </div>
                </div>
                <div className="customHeaderToolbar">
                  <CButtonGroup>
                    <CButton color="primary" active>
                      <i className="fa fa-plus mr-2" /> Create Tender
                    </CButton>
                  </CButtonGroup>
                </div>
              </div>
