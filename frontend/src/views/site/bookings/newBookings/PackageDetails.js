...
const PackageDetails = ({ handleChangeForm, bookingData, handleSelectFocus }) => {
  ...
  return (
    <>
      <CCol sm={6} md={6} lg={12} xl={6}>
        <h4 className="bkPageTitle">Package Details:-</h4>
      </CCol>
            ...
            <div className="form-group select optional loading_in_container">
              ...
              <div>
                <CFormSelect
                  ...
                  onFocus={() =>
                    dispatch(clearBookingError({ type: 'inContainer', errorType: 'errBooking' }))
                  }
                >
                        ...
                        <div className="row">
                          <div className="col-md-2 col-sm-4 col-xs-12">
                            <div className="form-group ">
                              <label className="control-label" htmlFor={`containerName_${item.id}`}>
                                Container No
                              </label>
                              <CFormInput
                                className="form-control-cst"
                            ...
                            <div className="row">
                              ...
                              <div className="col-md-2 col-sm-4 col-xs-6">
                                <div className="form-group loading_containers_sealno">
                                  <label className="control-label" htmlFor={`sealNo_${item.id}`}>
                                    Seal No
                                  </label>
                                  <CFormInput
                              ...
                              <div className="col-md-2 col-sm-4 col-xs-6">
                                <div className="form-group loading_containers_pack_total">
                                  <label className="control-label" htmlFor={`packTotal_${item.id}`}>
                                    Package Quantity
                                  </label>
                                  <CFormInput
        ...
        >
          <CCol sm={12} md={12} lg={12} xl={12} id="pack_details">
            ...
            {packageInput.length > 0
                    ...
                    >
                      ...
                      <div className="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                        <div className="row">
                          ...
                          {/* <div className="form-group hidden loading_packages_dimension_unit">
                            <CFormInput
                              className="form-control-cst hidden"
                              defaultValue="cm"
                              type="hidden"
                              id={`dimensionUnit-${item.id}`}
                              name="dimensionUnit"
              ...
              : null}
            <div className="mt-2">
              <CButton color="primary" onClick={handlePackageInput}>
                Add Package Line
              </CButton>
            </div>
            <hr />
              ...
              <CCol md={2} sm={2} lg={2} xl={2}>
                <div className="form-group float optional loading_total_pack">
                  ...
                  <CFormInput
                    ...
                    onChange={(e) => handleChangeForm(e)}
                    onFocus={() =>
                      dispatch(clearBookingError({ type: 'totalPack', errorType: 'errBooking' }))
                    }
                  />
                  <CFormFeedback invalid className="fieldError-cst">
              ...
              <CCol md={2} sm={2} lg={2} xl={2}>
                <div className="form-group float optional loading_ladameter">
                  ...
                  <CFormInput
                    ...
                    onChange={(e) => handleChangeForm(e)}
                    onFocus={() =>
                      dispatch(clearBookingError({ type: 'ladameter', errorType: 'errBooking' }))
                    }
                  />
                  <CFormFeedback
                    invalid={bookingErrors && !isEmpty(bookingErrors.ladameter) ? true : false}
          ...
          <CCol md={2} sm={2} lg={2} xl={2}>
            <div className="form-group select optional loading_commodity_type">
              ...
              <CFormSelect
                ...
                onFocus={() =>
                  dispatch(clearBookingError({ type: 'commodityType', errorType: 'errBooking' }))
                }
              >
          ...
          <CCol md={2} sm={2} lg={2} xl={2}>
            <div className="form-group decimal optional loading_optimum_temperature">
              ...
              <CFormInput
                ...
                invalid={bookingErrors && !isEmpty(bookingErrors.optimumTemperature) ? true : false}
                onChange={(e) => handleChangeForm(e)}
                onFocus={() =>
                  dispatch(
