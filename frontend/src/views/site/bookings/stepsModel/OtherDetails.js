  ...
  return (
    <div>
      <form
        ...
        id="new_loading"
        onSubmit={(e) => handleOtherDetailsBooking(e, '5')}
      >
        <h4 className="cstPageTitle">Other Details</h4>
        <h6 className="subTitleHeading">Step: 5/5</h6>
                ...
                <div className="form-group">
                  ...
                  <div className="checkbox-custom checkbox-primary">
                    <CFormCheck
                      ...
                      onFocus={() =>
                        dispatch(
                          clearBookingError({ type: 'letterOfCredit', errorType: 'errBooking' }),
                        )
                      }
                    />
                  </div>
              ...
              <CCol sm={6} md={3} lg={3} xl={3}>
                <div className="form-group select loading_service_type_id">
                  ...
                  <div className="input-group">
                    ...
                    <CFormFeedback
                      invalid={
                        bookingErrors && !isEmpty(bookingErrors.serviceTypeId) ? true : false
                      }
                      className="fieldError-cst"
                    >
                  ...
                  <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div className="form-group decimal loading_product_price">
                      ...
                      <CFormInput
                        ...
                        invalid={
                          bookingErrors && !isEmpty(bookingErrors.productPrice) ? true : false
                        }
                        onChange={(e) => handleChangeForm(e)}
                        onFocus={() =>
                          dispatch(
                            clearBookingError({ type: 'productPrice', errorType: 'errBooking' }),
                          )
                        }
                      />
                      <CFormFeedback
                  ...
                  <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div className="form-group select loading_product_curr">
                      ...
                      <div className="input-group">
                        ...
                        <CFormFeedback
                          invalid={
                            bookingErrors && !isEmpty(bookingErrors.productCurr) ? true : false
                          }
                          className="fieldError-cst"
                        >
              ...
              <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                >
                  {updatingBooking ? (
                    ...
                    <span>
                      Save <i className="fa fa-check ml-2" />
                    </span>
                  )}{' '}
                </CButton>
              </div>
...
OtherDetails.propTypes = {
  ...
  handleOtherDetailsBooking: PropTypes.func.isRequired,
}
