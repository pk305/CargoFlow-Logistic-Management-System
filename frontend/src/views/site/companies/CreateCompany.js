...
import { createCompany, showCompanyError, clearCompanyError } from 'src/redux/slices/companySlice'
...
const CreateCompany = () => {
  ...
  const { creatingCompany, companyErrors } = useSelector((state) => state.company)
  ...
  const handleSubmitCompany = async (e) => {
    ...
    if (form.length > 0) {
      ...
      if (companyData.cityId === '') {
        dispatch(showCompanyError({ type: 'cityId', errorType: 'errCompany' }))
        $(bd).animate({ scrollTop: 0 }, 300)
        return false
      }
      if (companyData.countryId === '') {
        dispatch(showCompanyError({ type: 'countryId', errorType: 'errCompany' }))
        $(bd).animate({ scrollTop: 0 }, 300)
        return false
      }
    }
    // form data
    let arrForm = Object.entries(companyData)
    ...
    const resData = await dispatch(createCompany(formData)).unwrap()
    if (resData) {
      new Noty({
        type: 'alert',
        layout: 'topRight',
      ...
      clearCompnyData()
      history.push(`/companies/${resData.linkId}`)
    }
  }
                ...
                <div className="customHeaderContainer">
                  ...
                  <div className="customHeaderContainer-footer">
                    <div className="card-title">
                      <h3 className="cstCardbodyHeaderTitle">New Company</h3>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <CForm id="new_company" onSubmit={(e) => handleSubmitCompany(e)}>
                  ...
                  <div className="pageBoxSizing-container">
                    ...
                    <div className="row">
                      ...
                      <div className="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div className="row">
                          <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <h4 className="titleHeading">Contacts</h4>
                          </div>
                        </div>

                        <div className="row">
                          <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            <div className="form-group string required company_contacts_name">
                              <label
                                className="control-label string required"
                                htmlFor="company_contacts_attributes_0_name"
                              >
                                Full Name <span>*</span>
                              </label>
                              <CFormInput
                                ...
                                type="text"
                                name="contactsAttrName"
                                id="company_contacts_attributes_0_name"
                                value={companyData.contactsAttrName}
                                onChange={(e) => handleChangeForm(e)}
                                invalid={
                                  companyErrors && !isEmpty(companyErrors.contactsAttrName)
                                    ? true
                                    : false
                                }
                                onFocus={() =>
                              ...
                              <CFormFeedback
                                ...
                                className="fieldError-cst"
                              >
                                {companyErrors.contactsAttrName}
                              </CFormFeedback>
                            </div>
                          </div>
                          <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            <div className="form-group company_contacts_jobtitle">
                              <label
                                className="control-label"
                                htmlFor="company_contacts_attributes_0_jobtitle"
                              >
                                Job Title
                              </label>
                              <CFormInput
                                className="form-control-cst"
                                type="text"
                                name="contactsAttrJobTitle"
                                id="company_contacts_attributes_0_jobtitle"
                                value={companyData.contactsAttrJobTitle}
                                onChange={(e) => handleChangeForm(e)}
                                invalid={
                                  companyErrors && !isEmpty(companyErrors.contactsAttrJobTitle)
                                    ? true
                                    : false
                                }
                                onFocus={() =>
                              ...
                              <CFormFeedback
                                ...
                                className="fieldError-cst"
                              >
                                {companyErrors.contactsAttrJobTitle}
                              </CFormFeedback>
                            </div>
                          </div>
                        </div>
                        <div className="row">
                          <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            <div className="form-group company_contacts_tel">
                              <label
                                className="control-label"
                                htmlFor="company_contacts_attributes_0_tel"
                              >
                                Phone
                              </label>
                              <CFormInput
                                className="form-control-cst mask_phone"
                                type="text"
                                name="contactsAttrTel"
                                id="company_contacts_attributes_0_tel"
                                value={companyData.contactsAttrTel}
                                onChange={(e) => handleChangeForm(e)}
                                invalid={
                                  companyErrors && !isEmpty(companyErrors.contactsAttrTel)
                                    ? true
                                    : false
                                }
                                onFocus={() =>
                              ...
                              <CFormFeedback
                                ...
                                className="fieldError-cst"
                              >
                                {companyErrors.contactsAttrTel}
                              </CFormFeedback>
                            </div>
                          </div>
                          <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            <div className="form-group email company_contacts_email">
                              <label
                                className="control-label email"
                                htmlFor="company_contacts_attributes_0_email"
                              >
                                E-Mail
                              </label>
                              <CFormInput
                                className="form-control-cst string email"
                                type="email"
                                name="contactsAttrEmail"
                                id="company_contacts_attributes_0_email"
                                value={companyData.contactsAttrEmail}
                                onChange={(e) => handleChangeForm(e)}
                                invalid={
                                  companyErrors && !isEmpty(companyErrors.contactsAttrEmail)
                                    ? true
                                    : false
                                }
                                onFocus={() =>
                              ...
                              <CFormFeedback
                                ...
                                className="fieldError-cst"
                              >
                                {companyErrors.contactsAttrEmail}
                              </CFormFeedback>
                            </div>
                          </div>
                        </div>
