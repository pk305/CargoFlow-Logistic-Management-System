...
import NewExpenseForm from './panels/NewExpenseForm'
          ...
          <div className="pageSearchContainer">
            <div className="filter-actions">
              ...
              <div className="filterSelected-text">
                {selectedFlatRows.length === 1 ? 'Company' : 'ExpenseForms'} Selected
              </div>
...
const ExpenseForms = () => {
  const [breadcrumbList] = useState([
    ...
    { name: 'Expense Forms', pathname: '/expense_forms?person_type=driver', active: true },
  ...
  const columns = useMemo(
    () => [
      ...
      {
        Header: <span>Transport Type</span>,
      ...
      {
        Header: <span>Total Advance</span>,
        accessor: 'Advance',
      },
      {
                ...
                <div className="customHeaderContainer">
                  <div className="customHeaderContainer-footer">
                    <div className="card-title">
                      <h3 className="cstCardbodyHeaderTitle">Expense Forms</h3>
                    </div>
                  </div>
                </div>
                <div className="customHeaderToolbar">
                  <CButtonGroup>
                    <CButton color="primary" active onClick={(e) => handleExpenseForm(e)}>
                      <i className="fa fa-plus mr-2" /> Create Expense Form
                    </CButton>
                  </CButtonGroup>
                </div>
              </div>
          ...
          <div className="space">
            ...
            <div>
              <button
                className="btn btn-close"
                aria-label="Close"
                onClick={(e) => setExpenseformPanel(false)}
              ></button>
            </div>
          </div>
        }
